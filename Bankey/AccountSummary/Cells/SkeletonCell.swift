...
class SkeletonCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        balanceAmountLayer.frame = balanceAmmountLabel.bounds
        balanceAmountLayer.cornerRadius = balanceAmmountLabel.bounds.height/2
    }
}
...
extension SkeletonCell {
    ...
    private func setUp() {
        ...
        balanceAmmountLabel.text = "-XXX,XXX.X-"
    ...
    private func setupLayers() {
        ...
        balanceAmmountLabel.layer.addSublayer(balanceAmountLayer)
    }
    ...
    private func setupAnimation() {
        ...
        balanceLayer.add(balanceGroup, forKey: "backgrounColor")
