...
class AccountTests: XCTestCase {
    ...
    func testCanParse() throws {
        ...
        XCTAssertEqual(result[0].createdDateTime.monthDayYearString, "junho 21, 2010")
        ...
        XCTAssertEqual(result[1].createdDateTime.monthDayYearString, "junho 21, 2010")
